    ...
    public partial class frmPokemon : Form
    {
        ...
        private void eliminar (bool logico = false)
        {
            ...
            try
            {
                ...
                if (respuesta == DialogResult.Yes)
                {
                    ...
                    if(logico)
                        negocio.elminarLogico(seleccionado.Id);
                    else
        ...
        private bool validarFiltro()
        {
            if(cboCampo.SelectedIndex < 0)
            {
                ...
                return true; //esto va a hacer que se cancele la accion del boton filtro, se llama abajo
            }
        ...
        private void txtFiltro_TextChanged(object sender, EventArgs e)
        {
            ...
            if (filtro.Length >= 3)
            {
                listaFiltrada = listaPokemon.FindAll(x => x.Nombre.ToLower().Contains(filtro.ToLower()) || x.Numero.ToString() == filtro.ToString() || x.Tipo.Descripcion.ToUpper().Contains(filtro.ToUpper()));
            }
            else
            {
